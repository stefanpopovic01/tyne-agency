...
const points = [
  {
    ...
    text: "Analiziraćemo vaš biznis",
  },
  {
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="M7 16l4-5 4 3 4-6"/></svg>,
    text: "Predložićemo strategiju rasta",
  },
  {
    ...
    text: "Pokazaćemo kako možemo da pomognemo",
  },
];
  ...
  return (
    <section className="cta-section" id="kontakt">
      ...
      <div className="clients">
        <div className="clients__label">Naši klijenti</div>
      ...
      <div className="bookcall">
        ...
        <div className="bookcall__inner">
          ...
          <div className="bookcall__left">
            <span className="bc__eyebrow">Besplatna konsultacija</span>
            <h2 className="bc__title">
              Spremi se za<br />
              <span className="bc__title-em">merljiv rast.</span>
            </h2>
            <p className="bc__subtitle">
              Jedan poziv — konkretna strategija prilagođena vašem biznisu.
              Bez obaveza.
            </p>
          </div>
          ...
          <div className="bookcall__right">
            ...
            <p className="bc__note">Bez obaveza · 100% besplatno · 30 min</p>
          </div>
